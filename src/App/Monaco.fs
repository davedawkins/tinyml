...
module Monaco =
    ...
    let [<ImportAll("monaco-editor")>] monaco: IExports = jsNative
    ...
    type [<AllowNullLiteral>] CancellationToken =
        ...
        /// but also only once.
        /// </summary>
        abstract onCancellationRequested: (obj option -> obj option) -> (obj) option -> (IDisposable[]) option -> IDisposable
    ...
    type [<AllowNullLiteral>] MarkdownStringTrustedOptions =
        abstract enabledCommands: string[]
    ...
    type [<AllowNullLiteral>] SelectionStatic =
        ...
        abstract selectionsArrEqual: a: ISelection[] * b: ISelection[] -> bool
    ...
    type [<AllowNullLiteral>] Token =
        ...
        abstract _tokenBrand: obj with get, set
        abstract toString: unit -> string
    ...
    module Editor =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract getEditors: unit -> ICodeEditor[]
            /// Get all the created diff editors.
            abstract getDiffEditors: unit -> IDiffEditor[]
            /// <summary>
            /// Create a new diff editor under <c>domElement</c>.
            /// <c>domElement</c> should be empty (not contain other dom nodes).
            /// The editor will read the size of <c>domElement</c>.
            /// </summary>
            abstract createDiffEditor: domElement: HTMLElement * ?options: IStandaloneDiffEditorConstructionOptions * ?``override``: IEditorOverrideServices -> IStandaloneDiffEditor
            ...
            abstract addKeybindingRules: rules: IKeybindingRule[] -> IDisposable
            /// <summary>
            ...
            abstract setModelMarkers: model: ITextModel * owner: string * markers: IMarkerData[] -> unit
            ...
            abstract getModelMarkers: filter: {| owner: string option; resource: Uri option; take: float option |} -> IMarker[]
            /// <summary>Emitted when markers change for a model.</summary>
            abstract onDidChangeMarkers: listener: (Uri[] -> unit) -> IDisposable
            /// <summary>Get the model that has <c>uri</c> if it exists.</summary>
            abstract getModel: uri: Uri -> ITextModel option
            /// Get all the created models.
            abstract getModels: unit -> ITextModel[]
            ...
            abstract tokenize: text: string * languageId: string -> Token[][]
            ...
            /// Register a command.
            abstract registerCommand: id: string * handler: (obj option -> obj option[] -> unit) -> IDisposable
        ...
        type [<AllowNullLiteral>] ICommandDescriptor =
        ...
        /// A keybinding rule.
        type [<AllowNullLiteral>] IKeybindingRule =
        ...
        type [<AllowNullLiteral>] IStandaloneThemeData =
            ...
            abstract encodedTokensColors: string[] option with get, set
        ...
        type [<AllowNullLiteral>] IStandaloneDiffEditorConstructionOptions =
        ...
        type [<AllowNullLiteral>] IContextKey<'T when 'T :> ContextKeyValue> =
            abstract set: value: 'T -> unit
            abstract reset: unit -> unit
            abstract get: unit -> 'T option

        type ContextKeyValue = interface end
//            U5<bool, float, string, Array<U3<bool, float, string> option>, Record<string, U3<bool, float, string> option>> option
        ...
        type [<AllowNullLiteral>] IMarker =
            ...
            abstract relatedInformation: IRelatedInformation[] option with get, set
            abstract tags: MarkerTag[] option with get, set
        ...
        type [<AllowNullLiteral>] InjectedTextOptions =
        ...
        type [<RequireQualifiedAccess>] InjectedTextCursorStops =
            | Both = 0
            | Right = 1
            | Left = 2
            | None = 3
        ...
        type [<AllowNullLiteral>] ICursorStateComputer =
            ...
            [<Emit("$0($1...)")>] abstract Invoke: inverseEditOperations: IValidEditOperation[] -> Selection[] option

        type [<AllowNullLiteral>] TextModelResolvedOptions =
            abstract _textModelResolvedOptionsBrand: obj with get, set
        ...
        type [<AllowNullLiteral>] BracketPairColorizationOptions =
        ...
        type [<AllowNullLiteral>] FindMatch =
            abstract _findMatchBrand: obj with get, set
            abstract range: Range
            abstract matches: string[] option
        ...
        type [<AllowNullLiteral>] ITextSnapshot =
        ...
        type [<AllowNullLiteral>] ITextModel =
            ...
            abstract findMatches: searchString: string * searchOnlyEditableRange: bool * isRegex: bool * matchCase: bool * wordSeparators: string option * captureMatches: bool * ?limitResultCount: float -> FindMatch[]
            /// <summary>Search the model.</summary>
            /// <param name="searchString">The string used to search. If it is a regular expression, set <c>isRegex</c> to true.</param>
            ...
            abstract findMatches: searchString: string * searchScope: U2<IRange, IRange[]> * isRegex: bool * matchCase: bool * wordSeparators: string option * captureMatches: bool * ?limitResultCount: float -> FindMatch[]
            ...
            abstract getLineDecorations: lineNumber: float * ?ownerId: float * ?filterOutValidation: bool -> IModelDecoration[]
            ...
            /// <param name="filterOutValidation">If set, it will ignore decorations specific to validation (i.e. warnings, errors).</param>
            /// <returns>An array with the decorations</returns>
            abstract getDecorationsInRange: range: IRange * ?ownerId: float * ?filterOutValidation: bool * ?onlyMinimapDecorations: bool -> IModelDecoration[]
            ...
            /// <param name="ownerId">If set, it will ignore decorations belonging to other owners.</param>
            /// <param name="filterOutValidation">If set, it will ignore decorations specific to validation (i.e. warnings, errors).</param>
            abstract getOverviewRulerDecorations: ?ownerId: float * ?filterOutValidation: bool -> IModelDecoration[]
            /// <summary>Gets all the decorations that contain injected text.</summary>
            /// <param name="ownerId">If set, it will ignore decorations belonging to other owners.</param>
            abstract getInjectedTextDecorations: ?ownerId: float -> IModelDecoration[]
            ...
            abstract pushEditOperations: beforeCursorState: Selection[] option * editOperations: IIdentifiedSingleEditOperation[] * cursorStateComputer: ICursorStateComputer -> Selection[] option
            ...
            abstract applyEdits: operations: IIdentifiedSingleEditOperation[] -> unit
            [<Emit("$0.applyEdits($1,false)")>] abstract applyEdits_false: operations: IIdentifiedSingleEditOperation[] -> unit
            [<Emit("$0.applyEdits($1,true)")>] abstract applyEdits_true: operations: IIdentifiedSingleEditOperation[] -> IValidEditOperation[]
        ...
        type [<RequireQualifiedAccess>] PositionAffinity =
        ...
        type [<AllowNullLiteral>] ILineChange =
            inherit IChange
            abstract charChanges: ICharChange[] option

        /// A document diff provider computes the diff between two text models.
        type [<AllowNullLiteral>] IDocumentDiffProvider =
            /// <summary>Computes the diff between the text models <c>original</c> and <c>modified</c>.</summary>
            abstract computeDiff: original: ITextModel * modified: ITextModel * options: IDocumentDiffProviderOptions -> Promise<IDocumentDiff>
            ...
            abstract onDidChange: IEvent<unit> with get, set
        ...
        type [<AllowNullLiteral>] IDocumentDiff =
            ...
            abstract changes: LineRangeMapping[]
        ...
        type [<AllowNullLiteral>] LineRangeMapping =
            ...
            abstract innerChanges: RangeMapping[] option
            abstract toString: unit -> string

        /// Maps a line range in the original text model to a line range in the modified text model.
        type [<AllowNullLiteral>] LineRangeMappingStatic =
            [<EmitConstructor>] abstract Create: originalRange: LineRange * modifiedRange: LineRange * innerChanges: RangeMapping[] option -> LineRangeMapping
        ...
        type [<AllowNullLiteral>] LineRange =
            ...
            abstract delta: offset: float -> LineRange
        ...
        type [<AllowNullLiteral>] ICursorStateComputerData =
            ...
            abstract getInverseEditOperations: unit -> IValidEditOperation[]
        ...
        type [<AllowNullLiteral>] IEditor =
            ...
            abstract getSelections: unit -> Selection[] option
            ...
            /// <param name="source">Source of the call that caused the selection</param>
            abstract setSelections: selections: ISelection[] * ?source: string -> unit
            ...
            abstract createDecorationsCollection: ?decorations: IModelDeltaDecoration[] -> IEditorDecorationsCollection

        /// A collection of decorations
        type [<AllowNullLiteral>] IEditorDecorationsCollection =
            ...
            abstract set: newDecorations: IModelDeltaDecoration[] -> unit
        ...
        type [<AllowNullLiteral>] IModelContentChangedEvent =
            abstract changes: IModelContentChange[]
        ...
        type [<AllowNullLiteral>] ICursorPositionChangedEvent =
            ...
            abstract secondaryPositions: Position[]
            /// Reason.
        ...
        type [<AllowNullLiteral>] ICursorSelectionChangedEvent =
            ...
            abstract secondarySelections: Selection[]
            /// The model version id.
            abstract modelVersionId: float
            /// The old selections.
            abstract oldSelections: Selection[] option
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] EditorAutoClosingEditStrategy =
            | Always
            | Auto
            | Never
        ...
        type [<AllowNullLiteral>] IEditorOptions =
            ...
            abstract rulers: U2<float, IRulerOption>[] option with get, set
        ...
        type [<AllowNullLiteral>] IEditorOption<'K, 'V> =
            abstract id: 'K
        ...
        type [<AllowNullLiteral>] ApplyUpdateResult<'T> =
            abstract newValue: 'T
            abstract didChange: bool

        type [<AllowNullLiteral>] ApplyUpdateResultStatic =
            [<EmitConstructor>] abstract Create: newValue: 'T * didChange: bool -> ApplyUpdateResult<'T>
        ...
        type [<AllowNullLiteral>] IEditorStickyScrollOptions =
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] QuickSuggestionsValue =
            | On
            | Inline
            | Off
        ...
        type [<AllowNullLiteral>] InternalQuickSuggestionsOptions =
        ...
        type [<AllowNullLiteral>] IUnicodeHighlightOptions =
        ...
        type [<AllowNullLiteral>] IInlineSuggestOptions =
        ...
        type [<AllowNullLiteral>] IGuidesOptions =
        ...
        type EditorOptionsType = interface end
...
//            ComputedEditorOptionValue<obj>
        ...
        type [<AllowNullLiteral>] IBaseMouseTarget =
            /// The target element
        ...
        type [<AllowNullLiteral>] IMouseTargetUnknown =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType

        type [<AllowNullLiteral>] IMouseTargetTextarea =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
        ...
        type [<AllowNullLiteral>] IMouseTargetMarginData =
        ...
        type [<AllowNullLiteral>] IMouseTargetMargin =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
            abstract position: Position
        ...
        type [<AllowNullLiteral>] IMouseTargetViewZoneData =
        ...
        type [<AllowNullLiteral>] IMouseTargetViewZone =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
            abstract position: Position
        ...
        type [<AllowNullLiteral>] IMouseTargetContentTextData =
            abstract mightBeForeignElement: bool

        type [<AllowNullLiteral>] IMouseTargetContentText =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
            abstract position: Position
        ...
        type [<AllowNullLiteral>] IMouseTargetContentEmptyData =
            abstract isAfterLines: bool
            abstract horizontalDistanceToText: float option

        type [<AllowNullLiteral>] IMouseTargetContentEmpty =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
            abstract position: Position
        ...
        type [<AllowNullLiteral>] IMouseTargetContentWidget =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
            abstract position: obj
        ...
        type [<AllowNullLiteral>] IMouseTargetOverlayWidget =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
            abstract position: obj
        ...
        type [<AllowNullLiteral>] IMouseTargetScrollbar =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
            /// The 'approximate' editor position
            abstract position: Position
        ...
        type [<AllowNullLiteral>] IMouseTargetOverviewRuler =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType

        type [<AllowNullLiteral>] IMouseTargetOutsideEditor =
            inherit IBaseMouseTarget
            abstract ``type``: MouseTargetType
        ...
        type [<AllowNullLiteral>] ICodeEditor =
            ...
            abstract executeEdits: source: string option * edits: IIdentifiedSingleEditOperation[] * ?endCursorState: U2<ICursorStateComputer, Selection[]> -> bool
            /// <summary>Execute multiple (concomitant) commands on the editor.</summary>
            /// <param name="source">The source of the call.</param>
            /// <param name="command">The commands to execute</param>
            abstract executeCommands: source: string option * commands: ICommand option[] -> unit
            /// Get all the decorations on a line (filtering out decorations from other editors).
            abstract getLineDecorations: lineNumber: float -> IModelDecoration[] option
            /// Get all the decorations for a range (filtering out decorations from other editors).
            abstract getDecorationsInRange: range: Range -> IModelDecoration[] option
            ...
            abstract removeDecorations: decorationIds: string[] -> unit
            /// Get the layout info for the editor.
            abstract getLayoutInfo: unit -> EditorLayoutInfo
            /// Returns the ranges that are currently visible.
            /// Does not account for horizontal scrolling.
            abstract getVisibleRanges: unit -> Range[]
        ...
        type [<AllowNullLiteral>] IDiffEditor =
            ...
            abstract getLineChanges: unit -> ILineChange[] option
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IExportsEditorOptionsAutoClosingBracketsIEditorOption =
            | Always
            | LanguageDefined
            | BeforeWhitespace
            | Never

        type [<StringEnum>] [<RequireQualifiedAccess>] IExportsEditorOptionsAutoClosingDeleteIEditorOption =
            | Always
            | Never
            | Auto

        type [<StringEnum>] [<RequireQualifiedAccess>] IExportsEditorOptionsAutoSurroundIEditorOption =
            | LanguageDefined
            | Never
            | Quotes
            | Brackets
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IExportsEditorOptionsExperimentalWhitespaceRenderingIEditorOption =
            | Off
            | Svg
            | Font
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IExportsEditorOptionsRenderFinalNewlineIEditorOption =
            | On
            | Off
            | Dimmed
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IExportsEditorOptionsWordBreakIEditorOption =
            | Normal
            | KeepAll
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IExportsEditorOptionsWordWrapOverride1IEditorOption =
            | On
            | Off
            | Inherit
        ...
        type [<AllowNullLiteral>] IExportsEditorOptions =
            ...
            abstract autoClosingQuotes: IEditorOption<EditorOption, IExportsEditorOptionsAutoClosingBracketsIEditorOption> with get, set
            ...
            abstract cursorSmoothCaretAnimation: IEditorOption<EditorOption, IExportsEditorOptionsCursorSmoothCaretAnimationIEditorOption> with get, set
            ...
            abstract experimentalWhitespaceRendering: IEditorOption<EditorOption, IExportsEditorOptionsExperimentalWhitespaceRenderingIEditorOption> with get, set
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IEditorOptionsCursorSmoothCaretAnimation =
            | Off
            | Explicit
            | On
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IEditorOptionsWordWrapOverride1 =
            | Off
            | On
            | Inherit
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IEditorOptionsExperimentalWhitespaceRendering =
            | Svg
            | Font
            | Off
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IEditorFindOptionsSeedSearchStringFromSelection =
            | Never
            | Always
            | Selection
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] IInlineSuggestOptionsMode =
            | Prefix
            | Subword
            | SubwordSmart

        type [<StringEnum>] [<RequireQualifiedAccess>] IInlineSuggestOptionsShowToolbar =
            | Always
            | OnHover
        ...
        type [<StringEnum>] [<RequireQualifiedAccess>] ISuggestOptionsSelectionMode =
            | Always
            | Never
    ...
    module Languages =
        ...
        let [<Import("css","module/monaco/languages")>] css: Css.IExports = jsNative
        let [<Import("html","module/monaco/languages")>] html: Html.IExports = jsNative
        let [<Import("json","module/monaco/languages")>] json: Json.IExports = jsNative
        //let [<Import("typescript","monaco-editor")>] typescript: Typescript.IExports = jsNative
        let typescript: Typescript.IExports = 
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract getLanguages: unit -> ILanguageExtensionPoint[]
            ...
            abstract setColorMap: colorMap: string[] option -> unit
            /// <summary>
            ...
            abstract registerReferenceProvider: languageSelector: LanguageSelector * provider: ReferenceProvider -> IDisposable
            /// Register a rename provider (used by e.g. rename symbol).
            abstract registerRenameProvider: languageSelector: LanguageSelector * provider: RenameProvider -> IDisposable
            /// Register a signature help provider (used by e.g. parameter hints).
            abstract registerSignatureHelpProvider: languageSelector: LanguageSelector * provider: SignatureHelpProvider -> IDisposable
            /// Register a hover provider (used by e.g. editor hover).
            abstract registerHoverProvider: languageSelector: LanguageSelector * provider: HoverProvider -> IDisposable
            /// Register a document symbol provider (used by e.g. outline).
            abstract registerDocumentSymbolProvider: languageSelector: LanguageSelector * provider: DocumentSymbolProvider -> IDisposable
            /// Register a document highlight provider (used by e.g. highlight occurrences).
            abstract registerDocumentHighlightProvider: languageSelector: LanguageSelector * provider: DocumentHighlightProvider -> IDisposable
            /// Register an linked editing range provider.
            abstract registerLinkedEditingRangeProvider: languageSelector: LanguageSelector * provider: LinkedEditingRangeProvider -> IDisposable
            /// Register a definition provider (used by e.g. go to definition).
            abstract registerDefinitionProvider: languageSelector: LanguageSelector * provider: DefinitionProvider -> IDisposable
            /// Register a implementation provider (used by e.g. go to implementation).
            abstract registerImplementationProvider: languageSelector: LanguageSelector * provider: ImplementationProvider -> IDisposable
            /// Register a type definition provider (used by e.g. go to type definition).
            abstract registerTypeDefinitionProvider: languageSelector: LanguageSelector * provider: TypeDefinitionProvider -> IDisposable
            /// Register a code lens provider (used by e.g. inline code lenses).
            abstract registerCodeLensProvider: languageSelector: LanguageSelector * provider: CodeLensProvider -> IDisposable
            /// Register a code action provider (used by e.g. quick fix).
            abstract registerCodeActionProvider: languageSelector: LanguageSelector * provider: CodeActionProvider * ?metadata: CodeActionProviderMetadata -> IDisposable
            /// Register a formatter that can handle only entire models.
            abstract registerDocumentFormattingEditProvider: languageSelector: LanguageSelector * provider: DocumentFormattingEditProvider -> IDisposable
            /// Register a formatter that can handle a range inside a model.
            abstract registerDocumentRangeFormattingEditProvider: languageSelector: LanguageSelector * provider: DocumentRangeFormattingEditProvider -> IDisposable
            /// Register a formatter than can do formatting as the user types.
            abstract registerOnTypeFormattingEditProvider: languageSelector: LanguageSelector * provider: OnTypeFormattingEditProvider -> IDisposable
            /// Register a link provider that can find links in text.
            abstract registerLinkProvider: languageSelector: LanguageSelector * provider: LinkProvider -> IDisposable
            /// Register a completion item provider (use by e.g. suggestions).
            abstract registerCompletionItemProvider: languageSelector: LanguageSelector * provider: CompletionItemProvider -> IDisposable
            /// Register a document color provider (used by Color Picker, Color Decorator).
            abstract registerColorProvider: languageSelector: LanguageSelector * provider: DocumentColorProvider -> IDisposable
            /// Register a folding range provider
            abstract registerFoldingRangeProvider: languageSelector: LanguageSelector * provider: FoldingRangeProvider -> IDisposable
            /// Register a declaration provider
            abstract registerDeclarationProvider: languageSelector: LanguageSelector * provider: DeclarationProvider -> IDisposable
            /// Register a selection range provider
            abstract registerSelectionRangeProvider: languageSelector: LanguageSelector * provider: SelectionRangeProvider -> IDisposable
            /// <summary>
            ...
            /// </summary>
            abstract registerDocumentSemanticTokensProvider: languageSelector: LanguageSelector * provider: DocumentSemanticTokensProvider -> IDisposable
            /// <summary>
            ...
            /// For the best user experience, register both a semantic tokens provider and a top-down tokenizer.
            /// </summary>
            abstract registerDocumentRangeSemanticTokensProvider: languageSelector: LanguageSelector * provider: DocumentRangeSemanticTokensProvider -> IDisposable
        ...
        type LanguageSelector =
            U3<string, LanguageFilter, ReadonlyArray<U2<string, LanguageFilter>>>

        type [<AllowNullLiteral>] LanguageFilter =
        ...
        type [<AllowNullLiteral>] TokensProviderFactory =
        ...
        type [<AllowNullLiteral>] CodeActionContext =
            ...
            abstract markers: Editor.IMarkerData[]
        ...
        type [<AllowNullLiteral>] CodeActionProviderMetadata =
            ...
            /// </summary>
            abstract providedCodeActionKinds: string[] option
        ...
        type [<AllowNullLiteral>] LanguageConfiguration =
            ...
            abstract colorizedBracketPairs: CharacterPair[] option with get, set
        ...
        type [<AllowNullLiteral>] CompletionItemRanges =
        ...
        type [<AllowNullLiteral>] CompletionItem =
            ...
            /// </summary>
            abstract commitCharacters: string[] option with get, set
            /// An optional array of additional text edits that are applied when
            /// selecting this completion. Edits must not overlap with the main edit
            /// nor with themselves.
            abstract additionalTextEdits: Editor.ISingleEditOperation[] option with get, set
        ...
        type [<AllowNullLiteral>] InlineCompletion =
            ...
            /// selecting this completion. Edits must not overlap with the main edit
            /// nor with themselves.
            abstract additionalTextEdits: Editor.ISingleEditOperation[] option
        ...
        type [<AllowNullLiteral>] InlineCompletions<'TItem when 'TItem :> InlineCompletion> =
            abstract items: 'TItem[]
            /// A list of commands associated with the inline completions of this list.
            abstract commands: Command[] option
        ...
        type [<AllowNullLiteral>] CodeAction =
            ...
            abstract diagnostics: Editor.IMarkerData[] option with get, set
        ...
        type [<RequireQualifiedAccess>] CodeActionTriggerType =
            | Invoke = 1
            | Auto = 2
        ...
        type [<AllowNullLiteral>] DocumentHighlightProvider =
            ...
            abstract provideDocumentHighlights: model: Editor.ITextModel * position: Position * token: CancellationToken -> ProviderResult<DocumentHighlight[]>

        /// The linked editing range provider interface defines the contract between extensions and
        /// the linked editing feature.
        type [<AllowNullLiteral>] LinkedEditingRangeProvider =
            /// Provide a list of ranges that can be edited together.
            abstract provideLinkedEditingRanges: model: Editor.ITextModel * position: Position * token: CancellationToken -> ProviderResult<LinkedEditingRanges>

        /// Represents a list of ranges that can be edited together along with a word pattern to describe valid contents.
        type [<AllowNullLiteral>] LinkedEditingRanges =
            /// A list of ranges that can be edited together. The ranges must have
            /// identical length and text content. The ranges cannot overlap
            abstract ranges: IRange[] with get, set
        ...
        type [<AllowNullLiteral>] ReferenceProvider =
            ...
            abstract provideReferences: model: Editor.ITextModel * position: Position * context: ReferenceContext * token: CancellationToken -> ProviderResult<Location[]>
        ...
        type Definition =
            U3<Location, Location[], LocationLink[]>
        ...
        type [<AllowNullLiteral>] DefinitionProvider =
            ...
            abstract provideDefinition: model: Editor.ITextModel * position: Position * token: CancellationToken -> ProviderResult<U2<Definition, LocationLink[]>>
        ...
        type [<AllowNullLiteral>] DeclarationProvider =
            ...
            abstract provideDeclaration: model: Editor.ITextModel * position: Position * token: CancellationToken -> ProviderResult<U2<Definition, LocationLink[]>>

        /// The implementation provider interface defines the contract between extensions and
        /// the go to implementation feature.
        type [<AllowNullLiteral>] ImplementationProvider =
            /// Provide the implementation of the symbol at the given position and document.
            abstract provideImplementation: model: Editor.ITextModel * position: Position * token: CancellationToken -> ProviderResult<U2<Definition, LocationLink[]>>

        /// The type definition provider interface defines the contract between extensions and
        /// the go to type definition feature.
        type [<AllowNullLiteral>] TypeDefinitionProvider =
            /// Provide the type definition of the symbol at the given position and document.
            abstract provideTypeDefinition: model: Editor.ITextModel * position: Position * token: CancellationToken -> ProviderResult<U2<Definition, LocationLink[]>>
        ...
        type [<AllowNullLiteral>] DocumentSymbol =
            ...
            abstract children: DocumentSymbol[] option with get, set
        ...
        type [<AllowNullLiteral>] DocumentSymbolProvider =
            ...
            abstract provideDocumentSymbols: model: Editor.ITextModel * token: CancellationToken -> ProviderResult<DocumentSymbol[]>
        ...
        type [<AllowNullLiteral>] DocumentFormattingEditProvider =
            ...
            abstract provideDocumentFormattingEdits: model: Editor.ITextModel * options: FormattingOptions * token: CancellationToken -> ProviderResult<TextEdit[]>
        ...
        type [<AllowNullLiteral>] DocumentRangeFormattingEditProvider =
            ...
            abstract provideDocumentRangeFormattingEdits: model: Editor.ITextModel * range: Range * options: FormattingOptions * token: CancellationToken -> ProviderResult<TextEdit[]>
        ...
        type [<AllowNullLiteral>] OnTypeFormattingEditProvider =
            ...
            /// </summary>
            abstract provideOnTypeFormattingEdits: model: Editor.ITextModel * position: Position * ch: string * options: FormattingOptions * token: CancellationToken -> ProviderResult<TextEdit[]>
        ...
        type [<AllowNullLiteral>] ILinksList =
            abstract links: ILink[] with get, set
            abstract dispose: unit -> unit
        ...
        type [<AllowNullLiteral>] IColorPresentation =
            ...
            /// </summary>
            abstract additionalTextEdits: TextEdit[] option with get, set
        ...
        type [<AllowNullLiteral>] DocumentColorProvider =
            ...
            abstract provideDocumentColors: model: Editor.ITextModel * token: CancellationToken -> ProviderResult<IColorInformation[]>
            /// Provide the string representations for a color.
            abstract provideColorPresentations: model: Editor.ITextModel * colorInfo: IColorInformation * token: CancellationToken -> ProviderResult<IColorPresentation[]>
        ...
        type [<AllowNullLiteral>] SelectionRangeProvider =
            ...
            abstract provideSelectionRanges: model: Editor.ITextModel * positions: Position[] * token: CancellationToken -> ProviderResult<SelectionRange[][]>
        ...
        type [<AllowNullLiteral>] FoldingRangeProvider =
            ...
            abstract provideFoldingRanges: model: Editor.ITextModel * context: FoldingContext * token: CancellationToken -> ProviderResult<FoldingRange[]>
        ...
        type [<AllowNullLiteral>] IWorkspaceTextEdit =
            abstract resource: Uri with get, set
        ...
        type [<AllowNullLiteral>] Command =
            ...
            abstract title: string with get, set
            abstract tooltip: string option with get, set
            abstract arguments: obj option[] option with get, set
        ...
        type [<AllowNullLiteral>] CodeLensList =
            abstract lenses: CodeLens[] with get, set
            abstract dispose: unit -> unit
        ...
        type [<AllowNullLiteral>] InlayHint =
            abstract label: U2<string, InlayHintLabelPart[]> with get, set
            abstract tooltip: U2<string, IMarkdownString> option with get, set
            abstract textEdits: TextEdit[] option with get, set
            abstract position: IPosition with get, set
        ...
        type [<AllowNullLiteral>] InlayHintList =
            abstract hints: InlayHint[] with get, set
            abstract dispose: unit -> unit

        type [<AllowNullLiteral>] InlayHintsProvider =
            abstract displayName: string option with get, set
            abstract onDidChangeInlayHints: IEvent<unit> option with get, set
            abstract provideInlayHints: model: Editor.ITextModel * range: Range * token: CancellationToken -> ProviderResult<InlayHintList>
        ...
        type [<AllowNullLiteral>] SemanticTokensLegend =
            ...
            abstract tokenModifiers: string[]
        ...
        type [<AllowNullLiteral>] SemanticTokensEdits =
            abstract resultId: string option
            abstract edits: SemanticTokensEdit[]
        ...
        type IMonarchLanguageAction =
            U3<IShortMonarchLanguageAction, IExpandedMonarchLanguageAction, U2<IShortMonarchLanguageAction, IExpandedMonarchLanguageAction>[]>
        ...
        module Css =
            ...
            type [<AllowNullLiteral>] CSSFormatConfiguration =
            ...
            type [<AllowNullLiteral>] CSSDataConfiguration =
            ...
            /// </summary>
            type [<AllowNullLiteral>] CSSDataV1 =
                abstract version: CSSDataV1Version with get, set
                abstract properties: IPropertyData[] option with get, set
                abstract atDirectives: IAtDirectiveData[] option with get, set
                abstract pseudoClasses: IPseudoClassData[] option with get, set
                abstract pseudoElements: IPseudoElementData[] option with get, set

            type [<StringEnum>] [<RequireQualifiedAccess>] EntryStatus =
                | Standard
                | Experimental
                | Nonstandard
                | Obsolete

            type [<AllowNullLiteral>] IReference =
                abstract name: string with get, set
                abstract url: string with get, set

            type [<AllowNullLiteral>] IPropertyData =
                abstract name: string with get, set
                abstract description: U2<string, MarkupContent> option with get, set
                abstract browsers: string[] option with get, set
                abstract restrictions: string[] option with get, set
                abstract status: EntryStatus option with get, set
                abstract syntax: string option with get, set
                abstract values: IValueData[] option with get, set
                abstract references: IReference[] option with get, set
                abstract relevance: float option with get, set

            type [<AllowNullLiteral>] IAtDirectiveData =
                abstract name: string with get, set
                abstract description: U2<string, MarkupContent> option with get, set
                abstract browsers: string[] option with get, set
                abstract status: EntryStatus option with get, set
            ...
            type [<AllowNullLiteral>] IPseudoClassData =
                abstract name: string with get, set
                abstract description: U2<string, MarkupContent> option with get, set
                abstract browsers: string[] option with get, set
                abstract status: EntryStatus option with get, set
            ...
            type [<AllowNullLiteral>] IPseudoElementData =
                abstract name: string with get, set
                abstract description: U2<string, MarkupContent> option with get, set
                abstract browsers: string[] option with get, set
                abstract status: EntryStatus option with get, set
            ...
            type [<AllowNullLiteral>] IValueData =
                abstract name: string with get, set
                abstract description: U2<string, MarkupContent> option with get, set
                abstract browsers: string[] option with get, set
                abstract status: EntryStatus option with get, set
            ...
            type [<AllowNullLiteral>] MarkupContent =
                abstract kind: MarkupKind with get, set
                abstract value: string with get, set

            type [<StringEnum>] [<RequireQualifiedAccess>] MarkupKind =
                | Plaintext
                | Markdown

            type [<StringEnum>] [<RequireQualifiedAccess>] CSSFormatConfigurationBraceStyle =
                | Collapse
                | Expand

            type [<StringEnum>] [<RequireQualifiedAccess>] OptionsLintCompatibleVendorPrefixes =
                | Ignore
                | Warning
                | Error

            type [<AllowNullLiteral>] OptionsLint =
            ...
            type [<RequireQualifiedAccess>] CSSDataV1Version = interface end
                // | N1 = 1
                // | N1_1 = 1.1
        ...
        module Html =
            ...
            type [<AllowNullLiteral>] IExports =
                ...
                abstract registerHTMLLanguageService: languageId: string * ?options: Options * ?modeConfiguration: ModeConfiguration -> LanguageServiceRegistration
            ...
            type [<AllowNullLiteral>] CompletionConfiguration =
                [<EmitIndexer>] abstract Item: providerId: string -> bool
            ...
            type [<AllowNullLiteral>] LanguageServiceRegistration =
                inherit IDisposable
                abstract defaults: LanguageServiceDefaults

            type [<AllowNullLiteral>] HTMLDataConfiguration =
            ...
            /// </summary>
            type [<AllowNullLiteral>] HTMLDataV1 =
                abstract version: HTMLDataV1Version
                abstract tags: ITagData[] option
                abstract globalAttributes: IAttributeData[] option
                abstract valueSets: IValueSet[] option

            type [<AllowNullLiteral>] IReference =
                abstract name: string
                abstract url: string

            type [<AllowNullLiteral>] ITagData =
                abstract name: string
                abstract description: U2<string, MarkupContent> option
                abstract attributes: IAttributeData[]
                abstract references: IReference[] option

            type [<AllowNullLiteral>] IAttributeData =
                abstract name: string
                abstract description: U2<string, MarkupContent> option
                abstract valueSet: string option
                abstract values: IValueData[] option
                abstract references: IReference[] option
            ...
            type [<AllowNullLiteral>] IValueSet =
                abstract name: string
                abstract values: IValueData[]
            ...
            type [<RequireQualifiedAccess>] HTMLDataV1Version = interface end
                // | N1 = 1
                // | N1_1 = 1.1
        ...
        module Json =
            ...
            type [<AllowNullLiteral>] DiagnosticsOptions =
                ...
                abstract schemas: {| uri: string; fileMatch: string[] option; schema: obj option |}[] option
            ...
            type [<StringEnum>] [<RequireQualifiedAccess>] SeverityLevel =
                | Error
                | Warning
                | Ignore
        ...
        module Typescript =
            ...
            type [<AllowNullLiteral>] IExports =
                ...
                abstract getTypeScriptWorker: unit -> Promise<(Uri[] -> Promise<TypeScriptWorker>)>
                abstract getJavaScriptWorker: unit -> Promise<(Uri[] -> Promise<TypeScriptWorker>)>
            ...
            type CompilerOptionsValue =
                U6<string, float, bool, U2<string, float>[], string[], MapLike<string[]>> option
            ...
            type [<AllowNullLiteral>] DiagnosticsOptions =
                ...
                abstract diagnosticCodesToIgnore: float[] option with get, set
            ...
            type [<AllowNullLiteral>] LanguageServiceDefaults =
                ...
                abstract setExtraLibs: libs: {| content: string; filePath: string option |}[] -> unit
            ...
            type [<AllowNullLiteral>] TypeScriptWorker =
                ...
                abstract getSyntacticDiagnostics: fileName: string -> Promise<Diagnostic[]>
                /// Get diagnostic messages for any semantic issues in the given file.
                abstract getSemanticDiagnostics: fileName: string -> Promise<Diagnostic[]>
                /// Get diagnostic messages for any suggestions related to the given file.
                abstract getSuggestionDiagnostics: fileName: string -> Promise<Diagnostic[]>
                ...
                abstract getCompilerOptionsDiagnostics: fileName: string -> Promise<Diagnostic[]>
                ...
                abstract getSignatureHelpItems: fileName: string * position: float * options: obj option -> Promise<obj option option>
                ...
                abstract getOccurrencesAtPosition: fileName: string * position: float -> Promise<obj option[] option>
                ...
                abstract getDefinitionAtPosition: fileName: string * position: float -> Promise<obj option[] option>
                ...
                abstract getReferencesAtPosition: fileName: string * position: float -> Promise<obj option[] option>
                ...
                abstract getNavigationBarItems: fileName: string -> Promise<obj option[]>
                ...
                abstract getFormattingEditsForDocument: fileName: string * options: obj option -> Promise<obj option[]>
                /// <summary>Get changes which should be applied to format the given range in the file.</summary>
                /// <param name="options"><c>typescript.FormatCodeOptions</c></param>
                /// <returns><c>Promise&lt;typescript.TextChange[]&gt;</c></returns>
                abstract getFormattingEditsForRange: fileName: string * start: float * ``end``: float * options: obj option -> Promise<obj option[]>
                /// <summary>Get formatting changes which should be applied after the given keystroke.</summary>
                /// <param name="options"><c>typescript.FormatCodeOptions</c></param>
                /// <returns><c>Promise&lt;typescript.TextChange[]&gt;</c></returns>
                abstract getFormattingEditsAfterKeystroke: fileName: string * postion: float * ch: string * options: obj option -> Promise<obj option[]>
                ...
                abstract findRenameLocations: fileName: string * positon: float * findInStrings: bool * findInComments: bool * providePrefixAndSuffixTextForRename: bool -> Promise<obj option[] option>
                ...
                abstract getCodeFixesAtPosition: fileName: string * start: float * ``end``: float * errorCodes: float[] * formatOptions: obj option -> Promise<obj option[]>
                /// <summary>Get inlay hints in the range of the file.</summary>
                /// <param name="fileName" />
                /// <returns><c>Promise&lt;typescript.InlayHint[]&gt;</c></returns>
                abstract provideInlayHints: fileName: string * start: float * ``end``: float -> Promise<obj option[]>
        ...
        type [<AllowNullLiteral>] IMonarchLanguageTokenizer =
            [<EmitIndexer>] abstract Item: name: string -> IMonarchLanguageRule[] with get, set

    module Worker =

        type [<AllowNullLiteral>] IMirrorTextModel =
            abstract version: float
